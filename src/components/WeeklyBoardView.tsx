    ...
    >
      ...
      <div className="px-4 pt-4 pb-3">
        <div className="flex items-baseline justify-between">
          <div>
            <h3
              className={clsx('text-sm font-bold', today ? 'text-surface-50' : 'text-surface-200')}
            >
              {format(date, 'EEEE')}
            </h3>
            <p className={clsx('text-xs mt-0.5', today ? 'text-accent-400' : 'text-surface-500')}>
              {format(date, 'MMMM d')}
            </p>
          </div>
        </div>
...
function SortableBoardTaskCard({
  task,
  onToggleDone,
  onClick,
  onStartTimer,
    ...
    >
      ...
      <div className="flex items-center justify-between mb-1.5">
        <div className="flex items-center gap-1.5">
          ...
          <div className="flex items-center gap-1">
            {task.recurrenceRuleId && <Repeat className="w-3 h-3 text-accent-500/60" />}
            {timeLabel ? (
